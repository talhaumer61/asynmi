      ...
      <!-- Page Header Start-->
        <div class="page-header">
            ...
            <div class="header-logo-wrapper col-auto p-0">  
                <div class="logo-wrapper"> <a href="/"><img class="img-fluid for-light" src="{{asset('assets/img/logo.png')}}" alt="logo-light"><img class="img-fluid for-dark" src="{{asset('assets/img/logo.png')}}" alt="logo-dark"></a></div>
