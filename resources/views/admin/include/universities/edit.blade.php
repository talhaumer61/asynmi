        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST"
              ...
              @php
                $selectedMonths = $university->intake_months
                    ? explode(',', $university->intake_months)
                    : [];
              @endphp
                  ...
                  <select name="country_id" class="form-select" required>
                    ...
                    @foreach($countries as $country)
                      <option value="{{ $country->id }}"
                        {{ $country->id == $university->country_id ? 'selected' : '' }}>
                        {{ $country->name }}
                      </option>
                    @endforeach
                  </select>
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text"
                         name="tuition_fee"
                         class="form-control"
                         value="{{ old('tuition_fee', $university->tuition_fee) }}"
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text"
                         name="ielts_score"
                         class="form-control"
                         value="{{ old('ielts_score', $university->ielts_score) }}"
                    ...
                    <div class="col-md-3 col-sm-4 col-6 mb-2">
                      <div class="form-check">
                        <input class="form-check-input"
                               ...
                               value="{{ $key }}"
                               id="month{{ $key }}"
                               {{ in_array($key, $selectedMonths) ? 'checked' : '' }}>
              ...
              <div class="mb-3">
                ...
                <div class="fake-dropzone text-center mb-3">
                  @if($university->image)
                      <img src="{{ asset($university->image) }}"
                            class="mb-3"
              ...
              <button class="btn btn-primary">Update University</button>
