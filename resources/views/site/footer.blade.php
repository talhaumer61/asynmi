    <div class="d-flex justify-content-center p-5">
        <a href="/contact-us" class="refer-btn btn-lg btn">Refer a Friend
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index.html"><img src="{{asset('assets/img/logo.png')}}" style="height: 120px" alt=""></a>
                            </div>
                            <h3>Want <span>to Take <br></span> Study Abroad<span>?</span></h3>
                            <a href="package-grid.html" class="primary-btn1">Get in Touch 
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-end justify-content-sm-end">
                        <div class="footer-widget">
                            <div class="single-contact mb-40">
                                ...
                                <a href="https://www.google.com/maps/place/Egens+Lab/@23.8340712,90.3631117,17z/data=!3m1!4b1!4m6!3m5!1s0x3755c14c8682a473:0xa6c74743d52adb88!8m2!3d23.8340663!4d90.3656866!16s%2Fg%2F11rs9vlwsk?entry=ttu">House 168/170, Johar Town, Lahore</a>
                            </div>
            ...
            <div class="footer-bottom">
                <div class="row">
                    <div class="col-lg-12 d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
                        ...
                        <p>© Copyright {{ date('Y') }} <a href="https://www.egenslab.com/">ASYNMI</a></p> 
